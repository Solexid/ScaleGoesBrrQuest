...
[assembly:MelonInfo(typeof(ScaleGoesBrrMod), "Scale Goes Brr Quest", "1.1.4", "knah/MagnaLuna/Solexid", "")]
...
namespace ScaleGoesBrr
{
    public partial class ScaleGoesBrrMod : MelonMod
    {
        ...
        private static readonly Func<VRCUiManager> GetUiManager;
        private static VRCVrCameraOculus OurOvrCamera;
        ...
        {
            GetUiManager = (Func<VRCUiManager>)Delegate.CreateDelegate(typeof(Func<VRCUiManager>), typeof(VRCUiManager)
              .GetProperties(BindingFlags.Static | BindingFlags.Public | BindingFlags.DeclaredOnly).First(it => it.PropertyType == typeof(VRCUiManager)).GetMethod);
        ...
        {
                ClassInjector.RegisterTypeInIl2Cpp<ScaleGoesBrrComponent>(true);
    ...
    private static IEnumerator OnUiManagerInitCoro(Action code) {
       ...
       code();
        ...
        private void OnUiManagerInit()
        {
            ...
            {
                var trackingOVR = vrcTracking.TryCast<VRCTrackingTouch>();
                if (trackingOVR == null) continue;

                OurOvrCamera = trackingOVR.GetComponentInChildren<VRCVrCameraOculus>();
                ourCameraTransform = OurOvrCamera.field_Private_Camera_0.transform;
        ...
        {
            OurOvrCamera.Method_Public_Virtual_New_Void_Vector3_0 (-offset / OurOvrCamera.transform.lossyScale.x);//field_Private_Vector3_0
        ...
        private static IEnumerator WaitForPlayerBrr(VRCPlayer player)
        {
            ...
            player.field_Private_VRCAvatarManager_0.
                Method_Internal_add_Void_MulticastDelegateNPublicSealedVoGaVRBoUnique_0(new Action<GameObject, VRC.SDKBase.VRC_AvatarDescriptor, bool>(OnLocalPlayerAvatarCreated)); var avatar = player.transform.Find("ForwardDirection/Avatar");
            if (avatar != null)
        ...
        private static IEnumerator OnLocalPlayerAvatarCreatedCoro(Vector3 originalScale, GameObject go)
        {
            ...
            comp.targetAl = OurOvrCamera.GetComponentInChildren<AudioListener>().transform;
